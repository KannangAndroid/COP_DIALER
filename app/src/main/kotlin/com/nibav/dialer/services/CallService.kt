...
import com.nibav.dialer.extensions.isOutgoing
import com.nibav.dialer.extensions.powerManager
import com.nibav.dialer.helpers.CallManager
import com.nibav.dialer.helpers.CallNotificationManager
import com.nibav.dialer.helpers.NoCall
    ...
    override fun onCallAdded(call: Call) {
        ...
        if (!powerManager.isInteractive || call.isOutgoing() || isScreenLocked || config.alwaysShowFullscreen) {
            try {
                ...
                startActivity(com.nibav.dialer.activities.CallActivity.getStartIntent(this))
            } catch (e: Exception) {
