...
import com.nibav.dialer.extensions.getPhoneAccountHandleModel
import com.nibav.dialer.extensions.putPhoneAccountHandle
...
class Config(context: Context) : BaseConfig(context) {
    ...
    var alwaysShowFullscreen: Boolean
        ...
        set(alwaysShowFullscreen) = prefs.edit().putBoolean(ALWAYS_SHOW_FULLSCREEN, true).apply()
