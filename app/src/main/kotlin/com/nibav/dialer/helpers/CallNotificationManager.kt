...
import com.nibav.commons.extensions.notificationManager
import com.nibav.commons.extensions.setText
import com.nibav.commons.extensions.setVisibleIf
import com.nibav.commons.helpers.isOreoPlus
import com.nibav.dialer.R
import com.nibav.dialer.activities.CallActivity
import com.nibav.dialer.extensions.powerManager
import com.nibav.dialer.receivers.CallActionReceiver
...
class CallNotificationManager(private val context: Context) {
    ...
    fun setupNotification(forceLowPriority: Boolean = false) {
        getCallContact(context.applicationContext, CallManager.getPrimaryCall()) { callContact ->
            ...
            val openAppIntent = com.nibav.dialer.activities.CallActivity.getStartIntent(context)
